  ...
  return (
    <div className="bg-light dark:bg-dark text-dark dark:text-light transition-colors duration-300 font-sans">
      ...
      <main>
          ...
          <div className="container">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-dark-lighter rounded-lg hover:bg-primary/10 transition-colors">
        ...
        {/* Experience Section */}
        <article id="experience" className="section py-20">
          <div className="container">
            <h2 className="section-title font-display">Work Experience</h2>
            <div className="space-y-8">
              <div className="card bg-light/50 dark:bg-dark/50 group animate-scale-in">
        ...
        {/* Projects Section */}
        <article id="projects" className="section bg-light/50 dark:bg-dark/50 py-20">
          <div className="container">
            ...
            <article className="section bg-light/50 dark:bg-dark/50 py-20">
          <div className="container">
            <h2 className="section-title font-display">Certificates & Recognition</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* STEAM Olympiad Certificate */}
              <div className="group relative overflow-hidden rounded-lg bg-dark-lighter animate-scale-in">
        ...
        {/* Contact Section */}
        <article id="contact" className="section py-8">
          <div className="container">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-light/50 dark:bg-dark/50 p-6 rounded-lg">
